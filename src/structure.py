...
plt.legend([circR, circY, circC, circB], ['Convecção fora do núcleo', 'Radiação fora do núcleo', 'Radiação dentro do núcleo', 'Convecção dentro do núcleo']) 
# plt.legend(loc = 2)
plt.xlabel('$R/R_{\odot}$')
plt.ylabel('$R/R_{\odot}$')
plt.title('Seção transversal de uma estrela', fontsize = 25)
opt_plot()
...
plt.title('Gradientes de temperatura')
ax = plt.gca()
ax.set_yscale('log')
...
plt.figure(figsize = (8,5))
plt.scatter(outer_convection_layer*R_0/R_Sun, Nabla_star[:len(outer_convection_layer)], color = 'firebrick', s = 12, edgecolors = 'k')
plt.plot(outer_convection_layer*R_0/R_Sun, Nabla_ad[:len(outer_convection_layer)],color = 'darkcyan')
opt_plot()
plt.xlabel('$R/R_{\odot}$')
plt.ylabel('$\\nabla$')
plt.legend(['$\\nabla_{estavel}$', '$\\nabla^{\star}}$','$\\nabla_{ad}$'], fontsize = 16, loc = 'upper center')
plt.title('Camada de convecção externa')
...
plt.title('Taxa de produção de energia')
opt_plot()
...
plt.title('Luminosidade', fontsize = 20)
plt.xlabel('$R/R_{\odot}$')
...
plt.title('Densidade', fontsize = 20)
plt.xlabel('$R/R_{\odot}$')
...
plt.title('Fração de energia transportada por convecção e radiação', fontsize = 17)
