...
def BulletPoint6():
    ...
    plt.ylabel("Produção Relativa de Energia")
    plt.title("Reações Nucleares")
    opt_plot()
    plt.savefig('Reactions_energy_production.png', dpi = 400)
    plt.show()
...
def BulletPoint7():
    ...
    plt.ylabel("G(E)")
    plt.title("Picos de Gamow (Normalizados)")
    opt_plot()
    plt.savefig("Gamow_peaks.png", dpi = 400)
    plt.show()
