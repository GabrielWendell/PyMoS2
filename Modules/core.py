"""
This is the Stellar_core module from the PyMoS2 package whose objective 
is to model energy production in the stellar core.
...
# plt.scatter(radius[:breaking_point]/R_Sun, l_eps, color = 'indigo', label = 'Energy Production')
plt.title('Energy Production vs. Radius')
plt.xlabel('$R/R_{\odot}$')
plt.ylabel('$\log{(\epsilon)}$ [J $\cdot$ kg$^{-1}$ s$^{-1}$]')
...
# plt.scatter(radius[:breaking_point]/R_Sun, l_pressure, color='sienna', label='Pressure')
...
# plt.scatter(radius[:breaking_point]/R_Sun, luminosity[:breaking_point]/L_Sun, color = 'crimson', label = 'Luminosity')
...
# plt.scatter(radius[:breaking_point]/R_Sun, l_density, color = 'mediumblue', label = 'Density')
...
# plt.scatter(radius[:breaking_point]/R_Sun, temperature[:breaking_point]/1e6, color = 'darkcyan', label = 'Temperature')
